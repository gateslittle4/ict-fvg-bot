...
function main() {
  ...
  const md = [];
  md.push('# Impact au niveau du COMPTE de la stratégie de divergence US100/US500 (lookback 100, seuil z=2) - risque 0.25%/trade');
  md.push('');
  md.push(
    `⚠ Compte $${STARTING_BALANCE}, risque fixe 0.25%/trade, un seul trade ouvert à la fois, PAS de garde-fous ` +
  ...
  const outMd = path.join(dir, 'divergence-account-impact-025.md');
