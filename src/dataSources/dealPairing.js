...
const LABEL_SOURCE_RE = /^auto-(fvg|divergence|nwog|judaswing|weeklysweep)-/;

/** @returns {string|null} 'fvg'|'divergence'|'nwog'|'judaswing'|'weeklysweep'|'pyramid', or null if the label doesn't identify a known source */
