...
const LABEL_SOURCE_RE = /^auto-(fvg|divergence|nwog|judaswing|weeklysweep|breakerblock)-/;

/** @returns {string|null} 'fvg'|'divergence'|'nwog'|'judaswing'|'weeklysweep'|'breakerblock'|'pyramid', or null if the label doesn't identify a known source */
