...
Trades analysés : 786 (dont 58 legs pyramid). Paires parent+pyramid superposées (= la définition même d'une "idée de trade" étendue par la règle) : 57.

| | Pire excursion flottante | % du solde | Dépassements strict (3%) | Dépassements souple (1%) |
|---|---|---|---|---|
| SOLO (une position) | 705.54$ | 0.50% | 0/786 | 0/786 |
| COMBINÉ (parent+pyramid) | 1196.56$ | 1.00% | 0/57 | 0/57 |
